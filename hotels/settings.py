...
SECRET_KEY = 'django-insecure-62^ru7=uwk@#xfr+naej7vei^&fdy1-(&72irp+7v0-a&1(1un'
...
MIDDLEWARE = [
    ...
    'app.middleware.NoCacheMiddleware', # Add this line to include the middleware in the project
...
TEMPLATES = [
    {
        ...
        'DIRS': [ BASE_DIR / 'templates' ], # Add this line to include the templates folder in the project
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
